...
//#define MPU_CORRECTION_FLASH     0x0800F000        // ›¥§µ     ? FLASH  ?  SIZE=6*3*4 ? 
//#define GG 9.8															//         ?
///*          Ú…?  6g */
//#define MPU_ACCE_M_S_2 (24.0 * GG / 32768.0) //  ¦Ë   ?  LSB  ?m/(s^2)  GG?   "X"          ? 
//#define MPU_GYRO_TO_DPS (2000 / 32768.0)    //  ¦Ë   ?  LSB  ? gegree/s
//#define MPU_MAGN_TO_GS (4800 / 16384.0 / 100.0)            //  ¦Ë   ?  LSB  ?Gs
//#define MPU_MAGN_TO_UT (4800 / 16384.0)            //  ¦Ë   ?  GS  ?UT
...
//		float yawsum;
//		/*      ? ?   ?    */
//		uint8_t DynamicOffsetEnable;	//  ?   §Ø ?§µ?  ?¦Ë
//		int32_t DynamicTmp[3];				//   ?     ? 
//		uint32_t DynamicTimes;				// §µ??     
//		uint16_t OffsetCnt;						// §µ?    
//		uint16_t OffsetErrorRange;		// §µ?  ?¦¶
//		float gyro_z;
//		int16_t yaw_turns;
//};
